...
<div class="row text-center py-4">
    ...
    <div class="col-md-6 px-5 pt-4">
        <h2><a id="Asantemap" tabindex="0">Asante Region</a></h2>
        <p></p>
    </div>
    <div class="col-md-6 px-5 pt-4">
    ...
    <!--center text, yelow outline of the akwamu empire at its height-->
    <div class="col-md-6 px-5 pt-4">
        <h2 style="text-align:center/center"><a id="voltamap" tabindex="0">Akwamu Empire</a></h2>
        <p></p>
    </div>
</div>
